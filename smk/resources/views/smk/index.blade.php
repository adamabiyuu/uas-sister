...
<body class="bg-light">
    <main class="container">
        <h1 class="mt-5">Data Smk</h1>
        @csrf
        <!-- Formulir untuk menambah video -->
        <form method="post" action="{{ route('smk.create') }}">
            @csrf
            <div class="mb-3 row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $smks->alamat }}</td>
                        <td>
                            <a href='{{ url("/smk/{$smks->id}/edit") }}' class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ url("/smk/{$smks->id}") }}" method="post" style="display: inline-block;">
                                @csrf
                                @method('delete')
